...
from waymo.waymo_object import WaymoObject

BASE_DIR = os.path.dirname(os.path.abspath(__file__))

import waymo.waymo_util as utils
import pickle
from waymo.waymo_object import *
import argparse
...
def demo(path):
    ...
    from waymo.viz_util import draw_lidar, draw_lidar_simple, draw_gt_boxes3d
    dataset = WaymoObject(path)
    data_idx = 0
...
if __name__=='__main__':
    ...
    parser.add_argument('--path', help='Waymo data path')
