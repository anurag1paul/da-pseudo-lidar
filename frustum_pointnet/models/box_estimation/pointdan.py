...
from models.box_estimation import BoxEstimationPointNet
...
__all__ = ['BoxEstimationPointDan', 'BoxEstimationSimpleDanNet']
...
class BoxEstimationSimpleDanNet(nn.Module):
